package com.hanki.hanki.ShopOrder.ShopPayment.IamPort.sdk;
...
public class KcpWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        ...
        if (!url.startsWith("http://") && !url.startsWith("https://") && !url.startsWith("javascript:")) { //처음실행시 false
            Intent intent = null;

            try {
                intent = Intent.parseUri(url, Intent.URI_INTENT_SCHEME); //IntentURI처리
                Uri uri = Uri.parse(intent.getDataString());
                Log.d("check2", "Uri : " + uri);
                ...
                if (packageName != null) {
                    ...
                    Log.d("check2", "packageName : " + packageName);
    ...
    protected boolean handleNotFoundPaymentScheme(String scheme) {
        ...
        if (PaymentScheme.ISP.equalsIgnoreCase(scheme)) {
            ...
            Log.d("check2", "Payment.ISP:scheme : " + scheme);
            return true;
            ...
            Log.d("check2", "Payment.BANKPAY:scheme : " + scheme);
            return true;
        }
